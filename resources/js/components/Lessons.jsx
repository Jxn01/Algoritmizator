 ...
 * Lessons component
 *
 * This component displays a list of lessons and their sublessons. Users can select a lesson and view its details,
 * including markdown content and quizzes. It includes a navbar, a sidebar with lessons, and a content area.
 * @param {Object} props - Component properties
 * @param {string} props.title - Title of the current page
 * @param {string} props.activeTab - Active tab of the navigation bar
 * @returns {JSX.Element} Lessons component
 */
const Lessons = memo(({ title, activeTab }) => {
    ...
    // Fetch lessons and user data on component mount
    useEffect(() => {
    ...
    // Inject code editors when the selected sublesson changes
    useEffect(() => {
    ...
    return (
        <div className="bg-gray-800">
            ...
            <div className="flex">
                {/* Sidebar with lessons and sublessons */}
                ...
                {/* Content area for selected lesson and sublesson */}
