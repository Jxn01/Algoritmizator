                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="mt-4">
                            ...
                            <div className="flex items-baseline justify-between mt-4">
                                ...
                                <a href="/login/forgot-password" className="text-sm text-purple-300 hover:underline">Elfelejtette jelszavát?</a>
                            </div>
                            <div className="mt-4 text-center">
                                ...
                                <a href="/registration" className="text-purple-200 hover:text-purple-400">Nincs fiókja? Regisztráljon</a>
                            </div>
                        </div>
                    </form>
                </div>
